...
export async function GET() {
  ...
  const [suppliers, invoices, transactions] = await Promise.all([
  ...
  return Response.json({ suppliers: suppliers.results, invoices: invoices.results, transactions: transactions.results });
}
