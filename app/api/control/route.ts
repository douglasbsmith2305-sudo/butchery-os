...
export async function GET() {
  ...
  const performance = productSales.results as Array<{ id:number;name:string;department:string;unit:string;costPrice:number;sellingPrice:number;stockQuantity:number;soldQuantity:number;revenue:number }>;
